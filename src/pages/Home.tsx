...
import { Settings, Clock, Send, ReceiptText } from 'lucide-react';
  ...
  return (
    <div className="app-container flex flex-col min-h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="text-gray-500 mb-16">{balance.toFixed(2)} USD</div>
        
        <div className="grid grid-cols-2 gap-6 w-full max-w-xs mx-auto mb-8">
